...
while quit != 1:
    ...
    if (selection == "addition"):
        a, b = input("\nInput the two numbers you wish to add: ").split()
        print(int(a) + int(b), "\n")
    elif (selection == "subtraction"):
        a, b = input("\nInput the two numbers you wish to subtract: ").split()
        print(int(a) - int(b), "\n")
    elif (selection == "multiplication"):
        a, b = input("\nInput the two numbers you wish to multiply: ").split()
        print(int(a) * int(b), "\n")
    elif (selection == "division"): 
        a, b = input("\nInput the two numbers you wish to divide: ").split()
        if (int(b) == 0):
